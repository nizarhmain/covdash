...
def latest_download():
    return send_file('data/csv/dpc-covid19-ita-regioni-latest.csv', as_attachment=True)

@app.route('/api/nazionale')
def latest_nazionale():
    return send_file('data/json/dpc-covid19-ita-andamento-nazionale.csv.json')
